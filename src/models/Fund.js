...
export default class Fund {
  constructor(fund) {
    ...
    this.rise = 0
    this.maxcap = fund ? Number(caver.utils.fromWei(fund.limit[0])) : 0;
    this.softcap = fund ? Number(caver.utils.fromWei(fund.limit[1])) : 0;
    this.min = fund ? Number(caver.utils.fromWei(fund.limit[2])) : 0;
    this.max = fund ? Number(caver.utils.fromWei(fund.limit[3])) : 0;
    ...
    this.distributionRate = fund ? Number(caver.utils.fromWei(fund.distributionRate)) : 0;
